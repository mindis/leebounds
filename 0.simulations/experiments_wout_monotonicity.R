...
source(paste0(my_path,"/simulate_data_wout_monotonicity.R"))
...
for (i_sel in 1:length(treat_effect_selections)) {
  for (i_wage in 1:length(treat_effect_wages)) {
    for (i_discrete in 1:length(p_discretes)) {
      ...
      print(paste0("Done for ","/0.simulations/Tables/N_rep",N_rep,"_N_",N,"_effect_selection_",treat_effect_selections[i_sel],
