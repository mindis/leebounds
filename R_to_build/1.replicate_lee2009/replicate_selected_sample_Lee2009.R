...
key_variables<-read.sas7bdat(paste0(my_path,"/JobCorps_data/key_vars.sas7bdat"))
mileston<-read.sas7bdat(paste0(my_path,"/JobCorps_data/mileston.sas7bdat"))
baseline<-read.sas7bdat(paste0(my_path,"/JobCorps_data/baseline.sas7bdat"))
empl_tl<-read.sas7bdat(paste0(my_path,"/JobCorps_data/empl_tl.sas7bdat"))  
...
#write_feather(full_data_nona,paste0(my_path,"/JobCorps_data/dataLee2009.feather"))
write.csv(full_data_nona,paste0(my_path,"/JobCorps_data/dataLee2009.csv"))
