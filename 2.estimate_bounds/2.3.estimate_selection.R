...
for (j in 1:length(weeks)) {
 ...
 # lasso_res[[week]]<-sapply(lasso.fit$coefficients,round,4)
  ...
  res_nm<-predict_selection(lasso.fit,leedata_cov)
...
write_feather(as.data.frame(s.0.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/s.0.hat.monotone.rlassologit.feather")
write_feather(as.data.frame(s.1.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/s.1.hat.monotone.rlassologit.feather")
write_feather(as.data.frame(s.0.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/s.0.hat.nonmonotone.rlassologit.feather")
write_feather(as.data.frame(s.1.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/s.1.hat.nonmonotone.rlassologit.feather")

write_feather(as.data.frame(p.0.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/p.0.hat.nonmonotone.rlassologit.feather")
write_feather(as.data.frame(p.0.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/p.0.hat.nonmonotone.rlassologit.feather")

write.csv(as.data.frame(s.0.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/s.0.hat.monotone.rlassologit.csv")
write.csv(as.data.frame(s.1.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/s.1.hat.monotone.rlassologit.csv")
write.csv(as.data.frame(s.0.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/s.0.hat.nonmonotone.rlassologit.csv")
write.csv(as.data.frame(s.1.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/s.1.hat.nonmonotone.rlassologit.csv")

write.csv(as.data.frame(p.0.hat.monotone),"First_Stage_Predicted_Values/Predicted_Selection/p.0.hat.nonmonotone.rlassologit.csv")
write.csv(as.data.frame(p.0.hat.nonmonotone),"First_Stage_Predicted_Values/Predicted_Selection/p.0.hat.nonmonotone.rlassologit.csv")
