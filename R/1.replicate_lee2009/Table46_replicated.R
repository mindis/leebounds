...
write.csv(table3,paste0(my_path,"/R/1.replicate_lee2009/tables/Table3_replicated.csv"))
## Table 6
...
write.csv(JobCorps_bounds_unweighted_table6,paste0(my_path,"/R/1.replicate_lee2009/tables/Table6_replicated.csv"))
