...
write.csv(table1,paste0(my_path,"/R/1.replicate_lee2009/tables/Table1_replicated.csv"))
...
write.csv(table2,paste0(my_path,"/R/1.replicate_lee2009/tables/Table2_replicated.csv"))
