...
report_results(orthoestimates_postlasso_girls,CR_ortho_postlasso_girls)
## ABBKK 2002, Table 1 column6
...
## ABBKK 2002, Table 2 (girls)  column 5
report_results(orthoestimates_postlasso_boys,CR_ortho_postlasso_boys)
## ABBKK 2002, Table 1 column 6
