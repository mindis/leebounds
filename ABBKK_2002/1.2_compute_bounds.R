...
for (subject in c("MATH","READING","WRITING")) {
  ...
  leebounds_ortho_result_boys<-ortho_leebounds_wout_monotonicity(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==1,],
                                                                 s.hat=s.hat.logistic[leedata_cov$SEX_NAME==1,],
  ...
  estimated_orthobounds_bb<-weighted_bb(leedata_cov[leedata_cov$SEX_NAME==1,],B=N_rep,
                                        ...
                                        y.hat=y.hat[leedata_cov$SEX_NAME==1,],s.hat=s.hat.logistic[leedata_cov$SEX_NAME==1,])
  ...
  leebounds_ortho_result_girls<-ortho_leebounds_wout_monotonicity(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==0,],
                                                                  s.hat=s.hat.logistic[leedata_cov$SEX_NAME==0,],
  ...
  estimated_orthobounds_bb<-weighted_bb(leedata_cov[leedata_cov$SEX_NAME==0,],B=N_rep,
                                        function_name=ortho_leebounds_wout_monotonicity,
                                        y.hat=y.hat[leedata_cov$SEX_NAME==0,],s.hat=s.hat.logistic[leedata_cov$SEX_NAME==0,])
...
report_results(orthoestimates,CR)
...
for (subject in c("MATH","READING","WRITING")) {
  leedata$outcome<-mydata[,subject]
  leedata_cov<-cbind(leedata,mydata[,exogenous_covariates])
  fit<-rlasso(form_outcome,leedata_cov)
...
for (subject in c("MATH","READING","WRITING")) {
  ...
  leebounds_ortho_result<-ortho_leebounds_wout_monotonicity(leedata_cov=leedata_cov,s.hat=s.hat.lasso,
                                                            quantile_grid_size = quantile_grid_size,
                                                            variables_for_outcome=c(vars_for_outcome,"SEX_NAME"))
  ...
  leebounds_ortho_result_boys<-ortho_leebounds_wout_monotonicity(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==1,],
                                                                 ...
                                                                 s.hat=s.hat.lasso[leedata_cov$SEX_NAME==1,],
                                                                 y.hat=y.hat[leedata_cov$SEX_NAME==1,])
  ...
  leebounds_ortho_result_girls<-ortho_leebounds_wout_monotonicity(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==0,],
                                                                  ...
                                                                  s.hat=s.hat.lasso[leedata_cov$SEX_NAME==0,],
                                                                  y.hat=y.hat[leedata_cov$SEX_NAME==0,])
...
for (subject in c("MATH","READING","WRITING")) {
  ...
  res_boys<-summary_subjects_positive_lower_bound(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==1,],
                                                  y.hat=y.hat[leedata_cov$SEX_NAME==1,],
                                                  s.hat=s.hat.lasso[leedata_cov$SEX_NAME==1,]) 
  
  estimates_plb_boys[[subject]]<-sort(GetBounds(res_boys))
  frac_positive_boys[[subject]]<-res_boys$fraction
  
  
  
  res_girls<-summary_subjects_positive_lower_bound(leedata_cov=leedata_cov[leedata_cov$SEX_NAME==0,],
                                                   y.hat=y.hat[leedata_cov$SEX_NAME==0,],
                                                   s.hat=s.hat.lasso[leedata_cov$SEX_NAME==0,]) 
  
  
  estimates_plb_girls[[subject]]<-sort(GetBounds(res_girls))
  frac_positive_girls[[subject]]<-res_girls$fraction
  ### inference ###
  ...
  res_bb_boys<-weighted_bb(mydata=leedata_cov[leedata_cov$SEX_NAME==1,],
                           function_name=summary_subjects_positive_lower_bound,
                           y.hat=y.hat[leedata_cov$SEX_NAME==1,],
                           s.hat=s.hat.lasso[leedata_cov$SEX_NAME==1,],inds_helps=(p.0.star[leedata_cov$SEX_NAME==1]<=1),B=N_rep)
  ...
  res_bb_girls<-weighted_bb(mydata=leedata_cov[leedata_cov$SEX_NAME==0,],
                            function_name=summary_subjects_positive_lower_bound,
                            y.hat=y.hat[leedata_cov$SEX_NAME==0,],
                            s.hat=s.hat.lasso[leedata_cov$SEX_NAME==0,],
