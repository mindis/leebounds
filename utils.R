...
plot_lee_orthobounds_with_pointwise_CI<-function(estimated_orthobounds,
  ...
  plot(weeks, estimated_leebounds[1,],lwd=4
       ,xlab="Week since random assignment",ylab="Treatment effect",col="blue",
       ylim=ylims,cex.main=1.5, cex.lab=1.5, cex.axis=1.5,cex=2)+
    title(paste0("Year ",year))+
    points(weeks,estimated_orthobounds[1,],col="red",lwd=4,cex=2)+
    points(weeks,estimated_orthobounds[2,],col="red",lwd=4,cex=2)+
    points(weeks,estimated_leebounds[2,],col="blue",lwd=4,cex=2)+
    points(weeks,estimated_orthobounds_CI[1,],col="black",lwd=3,pch=24,bg="red",cex=2)+
    points(weeks,estimated_orthobounds_CI[2,],col="black",lwd=3,pch=24,bg="red",cex=2)+
    points(weeks,estimated_leebounds_CI[1,],col="black",lwd=3,pch=24,bg="blue",cex=2)+
    points(weeks,estimated_leebounds_CI[2,],col="black",lwd=3,pch=24,bg="blue",cex=2)+
    abline(a=0,b=0)
  dev.off()
}
