...
prepared_data_sample_12m<-prepared_data_sample_12m[,c("treatment",list_of_basic_qje_controls,
...
B=400
for (i in c(1:4,13:15,16:19,24:27)) {
...
basic_trim_sd<-matrix(unlist(cluster_robust_se),nrow=3,byrow=FALSE)
rownames(basic_trim_sd)<-c("control_mean","itt","late")
...
write.csv(basic_trim_sd,paste0(my_path,"/OHIE/STEP2_Standard_Trim/csv/sd_basic_trim.csv"))
