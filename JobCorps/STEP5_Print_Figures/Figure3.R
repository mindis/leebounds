...
library(geomnet)
library(ggforce)
#sec.axis =sec_axis(~.*3, name = "Fraction of covariate groups"),
my_path<-"/net/holyparkesec/data/tata/leebounds/"
aspect_ratio<-1.5

Figure3_dataset<-read.csv(paste0(my_path,"/JobCorps/STEP5_Print_Figures/csv/Figure3_selected_covs3.csv"))
...
ggsave(paste0(my_path,"/JobCorps/Figures/Figure3_selected.png"),height=7,width=aspect_ratio*7)
