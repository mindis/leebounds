...
for (i in 1:length(weeks)) {
  ...
  leebounds_ortho_result<-ortho_leebounds(leedata_cov=leedata_cov,s.hat=s.hat,
                                          ...
                                          bounds_fun=ortho_bounds_nontreated_wage_ss)
  ...
  res<-summary_subjects_positive_lower_bound(leedata_cov_total=leedata_cov[,c("treat","selection","outcome",variables_for_outcome)],
                                             s.hat=leebounds_ortho_result$s.hat,
                                             y.hat=leebounds_ortho_result$y.hat)
...
Figure3_dataset<-data.frame(weeks=weeks[selected_weeks],
                            lb_positive=estimates_plb[1,selected_weeks],
                            ub_positive=estimates_plb[2,selected_weeks],
                            fraction=frac_positive[selected_weeks]
)
...
write.csv(Figure3_dataset,paste0(my_path,"/JobCorps/STEP3_MISC/csv/Figure3_selected_covs.csv"))
write.csv(Figure5_dataset,paste0(my_path,"/JobCorps/STEP3_MISC/csv/Figure5_selected_covs.csv"))