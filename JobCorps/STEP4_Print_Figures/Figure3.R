...
Figure3_dataset<-read.csv(paste0(my_path,"/JobCorps/STEP3_MISC/csv/Figure3_selected_covs.csv"))
...
ggplot(data=Figure3_dataset)+aes(x=weeks)+
  ...
  theme(legend.title =element_blank(),
        ...
        legend.text.align = 0)+
  scale_x_continuous(breaks = c(0,40,80,120,160,200),limits=c(0,210))
