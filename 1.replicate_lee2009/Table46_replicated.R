...
JobCorps_bb<-main_bb(leedata,N_rep=1000,function_name=leebounds)
...
write.csv(table3,paste0(my_path,"/R_code/1.replicate_lee2009/tables/Table3_replicated.csv"))
## Table 6
...
write.csv(JobCorps_bounds_unweighted_table6,paste0(my_path,"/R_code/1.replicate_lee2009/tables/Table6_replicated.csv"))
